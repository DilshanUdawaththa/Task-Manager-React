...
function TaskForm() {
  ...
  const validate = (values) => {
    ...
    } else if (!/^\d{2}\/\d{2}\/\d{4}$/.test(values.dueDate)) {
      errors.dueDate = "Date format should be dd/mm/yyyy";
    }
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input
            ...
            id="dueDate"
            name="dueDate"
            placeholder="Date here dd/mm/yyyyy"
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
          ...
          <div className="small text-danger">
            {formik.errors.dueDate ? (
              <div>{formik.touched.dueDate && formik.errors.dueDate}</div>
            ) : null}
          </div>
        </div>
